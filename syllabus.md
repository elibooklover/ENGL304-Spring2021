...
* [RStudio Cloud](https://rstudio.cloud/) : a cloud-based R environment which is free to use. You are not required to purchace a RStudio Cloud membership for this course. If you want to run R in your local environment, you can choose R & RStudio. [R](https://cran.r-project.org/) needs to be installed first in order to use RStudio. [RStudio](https://rstudio.com/products/rstudio/download/) is a user-friendly programming tool which is free to use.
